...
const Common_verification=lazy(()=>import('../common/common'))

const Email_Verification = () => {
  const [email, setemail] = useState("DILUS1322@GMAIL.COM");
         ...
         VERIFY YOUR EMAIL
          ...
          <div className={`absolute w-[10.63vw] h-[4.79vh] top-[13.98vh] left-[10.38vw]  flex flex-col
            text-center  items-center text-[1.09vw] mobile:text-[3.15vw]  ${style.phone_number_showing}`}>
              ...
              SEND OTP TO <span className={` text-[#4063F0BF] text-[1.39vw] mobile:text-[3.15vw]  `}>{email}</span>
